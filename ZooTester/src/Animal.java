...
public abstract class Animal{
    ...
    public String wakeUp(){
        return(this.name + " the " + this.aniType + " wakes up.");
    }

    //This method is the default for every animal in case we forget to override it in the subclasses.
    public String makeNoise(){
        return(this.name  + " the " + this.aniType + " makes a noise.");
    }

    public String eat(){
        return(this.name  + " the " + this.aniType + " eats.");
    }

    public String roam(){
        return(this.name  + " the " + this.aniType + " roams.");
    }

    public String sleep(){
        return(this.name  + " the " + this.aniType + " goes to sleep.");
    }
...
class Feline extends Animal{
    ...
    public String sleep(){
        ...
        //Otherwise, the feline will sleep (40% chance).
            ...
            return(aniName + " the " + aniType + " reluctantly goes to sleeps.");
        }
    }
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " purrs.");
    }
...
class Tiger extends Feline{
    ...
    public String eat(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " mauls down on its meal.");
    }
...
class Pachyderm extends Animal{
    ...
    public String roam(){
        ...
        if (chance <= 25){
            return(aniName + " the " +  aniType + " charges.");
        }
        //75% chance the method works as originally intended.
        else{
            return(aniName + " the " +  aniType + " roams.");
        }
    }
}
...
class Rhino extends Pachyderm{
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " grunts.");
    }
...
class Hippo extends Pachyderm{
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " groans.");
    }
...
class Elephant extends Pachyderm{
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " trumpets.");
    }
...
class Canine extends Animal{
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " growls.");
    }
    ...
    public String roam(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " chases its own tail.");
    }
}
...
class Dog extends Canine{
    ...
    public String roam(){
        ...
        if (chance <= 25){
            return(aniName + " the " + aniType + " digs.");
        }
...
class Cervidae extends Animal{
    ...
    public String makeNoise(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " bellows.");
    }

    public String eat(){
        String aniName = this.getName();
        String aniType = this.getAniType();
        return(aniName + " the " + aniType + " slowly chews its food.");
    }
